...
t.colormode(255)
color_list = [(240, 245, 241), (236, 239, 243), (149, 75, 50),
...
for dot_count in range(1, number_of_dots + 1):
    ...
    """
    if dot_count % 10 == 0: 
    This checks if dot_count is a multiple of 10 (i.e., every 10th dot).
    When dot_count is 10, 20, 30, etc., the condition is true.
    is used to determine when the turtle should move to the next line.
    """
    if dot_count % 10 == 0:
        t.setheading(90)
        t.forward(50)
